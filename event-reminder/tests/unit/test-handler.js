                ...
                blocks: [
                    {
                        ...
                        text: {
                            ...
                            text: '次回は、 *2021/7/29(木) 18:30* からです。\n' +
                                ...
                                '<http://www.google.com/calendar/event?action=TEMPLATE&text=大規模データ管理読書会&dates=20210729T183000/20210729T210000&location=リモート開催&trp=false|Google Calendarへ追加>'
                        }
                    }
                ],
                ...
                blocks: [
                    {
                        ...
                        text: {
                            ...
                            text: '次回は、 *2021/7/29(木) 18:30* からです。\n' +
                                'リマインダを登録: `/remind me 本日は大規模データ管理読書会です! on 7/29/2021 at 9:00am`\n' +
                                '<http://www.google.com/calendar/event?action=TEMPLATE&text=大規模データ管理読書会&dates=20210729T183000/20210729T210000&trp=false|Google Calendarへ追加>'
                        }
                    }
                ],
                response_type: "in_channel"
