...
describe('Tests index', function () {
    ...
    it('checks a location without location is not given', async () => {
                ...
                blocks: [
                    {
                        ...
                        text: {
                            ...
                            text: '次回は、 *2021/7/29 18:30* からです。\n' +
                                'リマインダを登録: `/remind me 本日はSystems Performance読書会です! on 7/29/2021 at 9:00am`\n' +
                                '<http://www.google.com/calendar/event?action=TEMPLATE&text=Systems_Performance読書会&dates=20210729T183000/20210729T210000&location=&trp=true&trp=undefined&trp=true&sprop=|Google Calendarへ追加>'
                        }
                    }
                ],
                response_type: "in_channel"
